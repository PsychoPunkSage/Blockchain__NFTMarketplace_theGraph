/*
  1. Save the Item in our Graph
  2. update our activeness

  3. get/create an itemListed object
  4. each item needs a unique Id

  -> ItemBoughtEvent: ✅ : Just the raw event
  -> ItemBoughtObject: ❌ : What we have => Autocreated in "generated > schema.ts"
*/ 
